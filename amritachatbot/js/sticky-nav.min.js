...
(function ($, window) {
  ...
  $.fn.stickyNavbar = function (prop) {
    ...
    function positionNavBar() {
      if($('#wpadminbar').length){
        adminBar = $('#wpadminbar').outerHeight() + 5;
      } else {
        adminBar = 70;
      }
      ...
      if ($(window).scrollTop() > 0) {
        if($(window).scrollTop() < heroHeight){
          navBar.css('position', 'absolute').css('margin-top', - navBarHeight+'px');
        }else{
          //navBar.css('position', 'fixed');
          navBar.css('position', 'fixed').css('margin-top', - navBarHeight - heroHeight - adminBar + 'px');
        }
        /*$(window).scrollTop() < heroHeight
          ? navBar.css('position', 'fixed').css('margin-top', - navBarHeight - $(window).scrollTop() - adminBar + 'px')
          : navBar.css('margin-top', - navBarHeight - heroHeight - adminBar + 'px');*/
      }
    }
